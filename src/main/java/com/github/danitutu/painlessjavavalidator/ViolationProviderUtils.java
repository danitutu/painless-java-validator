...
public class ViolationProviderUtils {
    ...
    /**
     * Creates {@link ViolationProvider}s from collection using a mapping function.
     * The mapping function receives a pair of <code>(i, o)</code> where <code>i</code>
     * is the index of current iterated element and <code>o</code> is the iterated
     * element. The function must return a {@link ViolationProvider}.
     *
     ...
     */
    public static <T> List<ViolationProvider> from(List<T> list,
