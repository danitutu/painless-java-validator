...
class AfterOrEqualsToValidationRuleTest {
    ...
    public void afterOrEqualsTo1() {
        ...
        map.forEach((key, value) -> {
            Optional<Violation> violation = ValidationRule
                    .afterOrEqualsToRule("field.path", (Comparable<Object>) key, value);
    ...
    public void afterOrEqualsTo5() {
        Optional<Violation> violation = ValidationRule.afterOrEqualsToRule("field.path", Instant.now(), null);
