...
import static com.vdt.painlessjavavalidator.ValidationRule.emptyRule;
...
class EmptyValidationRuleTest {
    ...
    public void empty1() {
        Optional<Violation> violation = emptyRule("field.path", null);
    ...
    public void empty2() {
        Optional<Violation> violation = emptyRule("field.path", "");
    ...
    public void empty3() {
        Optional<Violation> violation = emptyRule("field.path", "a value");
